...
@property (nonatomic, readonly) NSString* slideLabel;
...
/** Wraps a PresenterHandle; all methods are thread-safe (internal lock). */
...
/**
 * Render the audience slide into a pre-allocated RGBA8888 buffer.
